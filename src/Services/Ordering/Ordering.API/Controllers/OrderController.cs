...
namespace Ordering.API.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        {
            var command = new GetOrderListQuery(username);
        ...
        public async Task<ActionResult<int>> CheckoutOrder([FromBody] CheckoutOrderCommand newOrder)
        {
            int newOrderId = await _mediator.Send(newOrder);
